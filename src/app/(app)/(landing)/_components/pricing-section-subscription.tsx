...
const OfferCard = ({
  ...
  return (
    <div
      className={cn(
        "h-full transform-gpu overflow-hidden rounded-2xl border bg-neutral-800/95 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-neutral-800/100 dark:bg-neutral-800/50",
  ...
  return (
    <nav className="flex flex-col sm:flex-row">
      {OfferList.map((button, _index) => (
        <button
          className={cn(
            "relative inline-flex w-fit transform-gpu whitespace-nowrap px-6 py-2.5 text-lg font-semibold capitalize tracking-tight transition-colors",
        ...
        >
          ...
          {selectedBilledType === button && (
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 top-0 -z-10 rounded-full bg-neutral-200 dark:bg-neutral-800"
