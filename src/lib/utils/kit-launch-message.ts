...
/**
 * ASCII art for Bones logo with a smooth left-to-right gradient
 */
const bonesArt = `
${createGradient("   ██████╗  ██████╗ ███╗   ██╗███████╗███████╗")}
${createGradient("   ██╔══██╗██╔═══██╗████╗  ██║██╔════╝██╔════╝")}
 ...
 * for Bones, making the startup experience more engaging for non-coders.
 *
