...
export const env = createEnv({
	...
	runtimeEnv: {
		...
		// Google Analytics
		NEXT_PUBLIC_FEATURE_GOOGLE_ANALYTICS_ENABLED: process.env.NEXT_PUBLIC_FEATURE_GOOGLE_ANALYTICS_ENABLED,
		NEXT_PUBLIC_GOOGLE_ANALYTICS_ID: process.env.NEXT_PUBLIC_GOOGLE_ANALYTICS_ID,

		// Google Tag Manager
		NEXT_PUBLIC_FEATURE_GOOGLE_TAG_MANAGER_ENABLED: process.env.NEXT_PUBLIC_FEATURE_GOOGLE_TAG_MANAGER_ENABLED,
