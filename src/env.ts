...
export const env = createEnv({
	...
	client: {
		...
		// Google Analytics
		NEXT_PUBLIC_FEATURE_GA_ENABLED: zBooleanFeatureFlag,
		NEXT_PUBLIC_GA_ID: z.string().optional(),

		// Google Tag Manager
		NEXT_PUBLIC_FEATURE_GTM_ENABLED: zBooleanFeatureFlag,
	...
	runtimeEnv: {
		...
		// Google Tag Manager
		NEXT_PUBLIC_FEATURE_GTM_ENABLED: process.env.NEXT_PUBLIC_FEATURE_GTM_ENABLED,
