...
export const InputHover = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, type, ...props }, ref) => {
      ...
      `,
				...
				className="group/input rounded-lg p-[2px] transition duration-300 [--highlight:hsl(var(--primary))]"
			>
				<input
					type={type}
					className={cn(
